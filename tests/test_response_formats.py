...
class TestResponseFormats:
    """Tests for Response Formats endpoints"""

    @retry()
    def test_brotli_returns_brotli_encoded_data(self, api_client):
    ...
    @retry()
    def test_deflate_returns_deflate_encoded_data(self, api_client):
    ...
    @retry()
    def test_deny_returns_denied_page(self, api_client):
    ...
    @retry()
    def test_encoding_utf8_returns_utf8_body(self, api_client):
    ...
    @retry()
    def test_gzip_returns_gzip_encoded_data(self, api_client):
    ...
    @retry()
    def test_html_returns_html_document(self, api_client):
    ...
    @retry()
    def test_json_returns_json_document(self, api_client):
    ...
    @retry()
    def test_robots_txt_returns_robots_rules(self, api_client):
    ...
    @retry()
    def test_xml_returns_xml_document(self, api_client):
