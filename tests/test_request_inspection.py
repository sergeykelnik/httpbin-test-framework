...
class TestRequestInspection:
    ...
    """Tests for Request Inspection endpoints"""
    @retry()
    def test_headers_returns_request_headers(self, api_client):
    ...
    @retry()
    def test_ip_returns_requester_ip(self, api_client):
    ...
    @retry()
    def test_user_agent_returns_user_agent_header(self, api_client):
