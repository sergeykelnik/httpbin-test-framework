...
class TestDynamicData:
    """Tests for Dynamic Data endpoints"""

    @retry()
    def test_base64_decodes_value(self, api_client):
        """Test GET /base64/{value} decodes base64url-encoded string"""
        test_string = test_data.random_sentence(3)
        base64_str = base64.b64encode(bytes(test_string, 'utf-8')).decode('utf-8')
    ...
    @retry()
    def test_bytes_returns_n_random_bytes(self, api_client):
    ...
    def test_delay_returns_delayed_response(self, api_client, method):
    ...
    @retry()
    def test_drip_returns_dripped_data(self, api_client):
    ...
    @retry()
    def test_links_generates_page_with_links(self, api_client):
    ...
    @retry()
    def test_range_streams_numbytes(self, api_client):
        ...
        assert response.headers.get("Content-Range") == f"bytes 0-{numbytes -1}/{numbytes}"
        assert response.headers.get("Accept-Ranges") == "bytes"


    @retry()
    def test_stream_bytes_returns_n_bytes(self, api_client):
    ...
    @retry()
    def test_stream_returns_n_json_responses(self, api_client):
    ...
    @retry()
    def test_uuid_returns_valid_uuid4(self, api_client):
    ...
    @retry()
    def test_uuid_generates_different_values(self, api_client):
